...
def detect(cfg,opt):
    ...
    for i, (path, img, img_det, vid_cap,shapes) in tqdm(enumerate(dataset),total = len(dataset)):
        if i==0 and CHOSEN_POINTS_COUNTER!=2:

            if CHOSEN_POINTS_COUNTER ==0:
                print("\nwybierz dolną krawędź wykrywania")
            elif CHOSEN_POINTS_COUNTER == 1:
                print("wybierz górną krawędź wykrywania")
        ...
        if CHOSEN_POINTS_COUNTER == 2:
            dolna_krawedz = CHOSEN_POINTS[0]
            gorna_krawedz = CHOSEN_POINTS[1]
            ...
            for i in range(points_density):
                obszar_wykrywania = dolna_krawedz[1]-gorna_krawedz[1]
                horizontal_line=dolna_krawedz[1]-1-(i*obszar_wykrywania//points_density)
